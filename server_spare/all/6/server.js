...
var variables = {
 ...
 //  TEST1: 'DB2,REAL0',
   ...
   //////////start
    ...
    conn1.initiateConnection({ port: 102, host: '192.168.0.1', rack: 0, slot: 1, debug: false }, connected); // slot 2 for 300/400, slot 1 for 1200/1500, change debug to true to get more info
